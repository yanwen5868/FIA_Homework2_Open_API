...
//    })
//    @ApiOperation(value="依據統一編號取得非營利事業單位資料")
//    @RequestMapping(value = "/{ban}", method = RequestMethod.GET)
//    @ResponseBody
//    public ResponseEntity<PeriodRateBean> getByPkey(
//            @ApiParam(value="非營利事業單位統一編號", required=true) @PathVariable String ban) {
//        PeriodRate entity = PeriodRateService.getByPkey(ban);
//        if (entity != null) {
...
//    }
    ...
    @ApiOperation(value="依分頁大小取得每旬匯率資料")
...
/*    @ApiResponses(value={
    ...
    @ResponseBody
    public ResponseEntity<List<PeriodRateBean>> listByCondition(
    ...
    public ResponseEntity<PeriodRateBean> create(PeriodRateBean bean) {
        ...
        Map<String, Object> query = getQuery(bean.getCurrency(), bean.getYear(), bean.getMonth(), bean.hashCode(), null);
        List<PeriodRate> entitys = PeriodRateService.listByCondition(query);
